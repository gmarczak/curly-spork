...
## Warunek wejścia
Kandydat przeszedł ocenę w `00_STRATEGIA/Proces_Wyboru_Produktu.md` (wynik ≥ 45/65 pkt, brak kryteriów eliminujących).
...
3. **Znajdź i zweryfikuj dostawcę:** wypełnij `Dostawcy_Fulfillment/Szablon_Karty_Dostawcy.md`. Domyślny model startowy: dropshipping (tabela decyzji logistycznej: `00_STRATEGIA/Business_Plan_i_Koncepcja.md`, sekcja 5.1). Ustal adres zwrotów w PL/UE.
4. **Skonkretyzuj prompty agentów:** wypełnij `Prompty_dla_Agentow/Prompty_Systemowe.md` na bazie Specyfikacji.
...
10. **Monitoruj KPI** codziennie w `Analityka_Wyniki/KPI_Produktu.md`.
